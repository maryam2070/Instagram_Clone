...
fun LoginScreen(navController: NavController) {
    ...
    when (val response = viewModel.signIn.value) {
        is Response.Error -> {
    ...
    Box(modifier = Modifier.fillMaxSize(), contentAlignment = Alignment.Center) {
        ...
        Column(
            ...
            OutlinedTextField(value = viewModel.email.value,
                ...
                supportingText = {
                    viewModel.emailValidation.value?.let {
                        if (!it.isSuccess) {
                            Text(
                                text = ContextCompat.getString(LocalContext.current, it.message),
            ...
            Text(text = "New ? Sign Up Now ", modifier = Modifier.clickable {
